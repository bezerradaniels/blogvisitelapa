...
export const adInventory: AdInventoryItem[] = [
  ...
  { code: 'post_sidebar', name: 'Artigo/listagem — lateral', location: 'Coluna lateral direita', pages: 'Artigos e página “Artigos”', desktop: '300 × 300', mobile: 'Não exibido', capacity: 3, status: 'implemented' },
